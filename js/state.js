...
const PHASE_TRANSITIONS = Object.freeze({
  [GAME_PHASES.INIT]: [GAME_PHASES.PLAYING, GAME_PHASES.RULE_DRAFT],
  [GAME_PHASES.PLAYING]: [GAME_PHASES.SCORING],
  [GAME_PHASES.SCORING]: [GAME_PHASES.CARD_DRAFT, GAME_PHASES.SHOP, GAME_PHASES.GAME_OVER],
  ...
  [GAME_PHASES.NEXT_ROUND]: [GAME_PHASES.PLAYING, GAME_PHASES.RULE_DRAFT, GAME_PHASES.GAME_OVER],
