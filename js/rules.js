...
export const RULE_LIBRARY = Object.freeze([
  ...
  { id: "fruit-combo-three", name: "水果三连", description: "本轮水果连击达到 3 或以上", scope: "min_fruit_combo", count: 3, target_type: "水果", gold_reward: 3, difficulty: 2 },
  { id: "fruit-combo-five", name: "水果盛宴", description: "本轮水果连击达到 5 或以上", scope: "min_fruit_combo", count: 5, target_type: "水果", gold_reward: 6, difficulty: 4, min_round: 3 },
