...
const CARD_DEFS = [
  ...
  card({ id: "P010", name: "美食评论家", rarity: "罕见", type: "人物", edibility: INEDIBLE, eat_points: -2, discard_points: 2, role: SETUP, synergy_tags: ["人物", "预判", "成长"], effect: { kind: "review_next_edibility", description: "弃：若下一张牌可食用，其结算时额外 +3；若不可食用，其吃点永久 +1", trigger_action: "discard", edible_bonus: 3, inedible_eat_growth: 1 } }),
