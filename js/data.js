...
const CARD_DEFS = [
  ...
  card({ id: "F001", name: "苹果", flavor: "一颗普通的苹果。", rarity: "普通", type: "水果", edibility: EDIBLE, eat_points: 1, discard_points: -1, role: BASELINE, shop_price_adjustment: -2, synergy_tags: ["水果", "连击", "基础"], effect: { kind: "fruit_combo", description: "吃：水果连击 +1", trigger_action: "eat", combo_gain: 1, bonus_per_combo: 1 } }),
  card({ id: "F002", name: "香蕉", rarity: "普通", type: "水果", edibility: EDIBLE, eat_points: 1, discard_points: -1, role: ENGINE, synergy_tags: ["水果", "连击", "生成"], effect: { kind: "fruit_combo", description: "吃：水果连击 +1；连击达到 3 或以上时生成 1 张苹果，本轮限 1 次", trigger_action: "eat", combo_gain: 1, bonus_per_combo: 1, generate_at: 3, generate_card_id: "F001", once_per_round: true } }),
  card({ id: "F003", name: "西瓜", rarity: "稀有", type: "水果", edibility: EDIBLE, eat_points: 2, discard_points: -1, role: PAYOFF, synergy_tags: ["水果", "连击", "收割"], effect: { kind: "fruit_combo", description: "吃：水果连击 +1；连击达到 3 或以上时再额外 +3", trigger_action: "eat", combo_gain: 1, bonus_per_combo: 1, threshold: 3, threshold_bonus: 3 } }),
  ...
  card({ id: "F005", name: "金苹果", rarity: "普通", type: "水果", edibility: EDIBLE, eat_points: 2, discard_points: -1, role: ENGINE, synergy_tags: ["水果", "连击", "成长"], effect: { kind: "fruit_combo", description: "吃：水果连击 +1；连击达到 4 或以上时，自身吃分永久 +1", trigger_action: "eat", combo_gain: 1, bonus_per_combo: 1, grow_at: 4, grow_amount: 1 } }),
  card({ id: "F006", name: "腐烂苹果", rarity: "罕见", type: "水果", edibility: EDIBLE, eat_points: -1, discard_points: -2, role: SACRIFICE, synergy_tags: ["水果", "连击", "牺牲"], effect: { kind: "fruit_combo", description: "吃：水果连击 +1；若连击前为 0，本牌额外 +4，否则按连击正常加分", trigger_action: "eat", combo_gain: 1, bonus_per_combo: 1, opener_bonus: 4 } }),
  card({ id: "F007", name: "水果拼盘", rarity: "稀有", type: "水果", edibility: EDIBLE, eat_points: 2, discard_points: -1, role: ENGINE, synergy_tags: ["水果", "连击", "生成", "弱化"], effect: { kind: "fruit_combo", description: "吃：水果连击 +2；连击达到 4 或以上时，本轮首次随机生成 1 张【弱化】水果", trigger_action: "eat", combo_gain: 2, bonus_per_combo: 1, generate_at: 4, generate_random_type: "水果", generate_weakened: true, once_per_round: true } }),
  card({ id: "F008", name: "火龙果", rarity: "传奇", type: "水果", edibility: EDIBLE, eat_points: 3, discard_points: -2, role: PAYOFF, synergy_tags: ["水果", "连击", "爆发"], effect: { kind: "fruit_combo", description: "吃：水果连击 +1；连击达到 5 或以上时，水果连击加分翻倍", trigger_action: "eat", combo_gain: 1, bonus_per_combo: 1, double_at: 5 } }),
  card({ id: "F009", name: "梨", art_file: "cards/f009-v2.png", rarity: "普通", type: "水果", edibility: EDIBLE, eat_points: 1, discard_points: -1, role: ENGINE, shop_price_adjustment: -1, synergy_tags: ["水果", "连击", "刷新"], effect: { kind: "fruit_combo", description: "吃：水果连击 +1；连击达到 3 或以上时获得 1 枚刷新标记", trigger_action: "eat", combo_gain: 1, bonus_per_combo: 1, grant_reroll_at: 3, reroll_tokens: 1 } }),
  card({ id: "F010", name: "糖渍梅", art_file: "cards/f010-v2.png", rarity: "罕见", type: "水果", edibility: EDIBLE, eat_points: 1, discard_points: -1, role: SETUP, synergy_tags: ["水果", "连击", "修复"], effect: { kind: "fruit_combo_resume", description: "吃：水果连击 +1；若本轮曾中断连击，则从本轮最高连击恢复（恢复值最多为 5），每轮限 1 次", trigger_action: "eat", combo_gain: 1, max_resume: 5, bonus_per_combo: 1, once_per_round: true } }),
  ...
  card({ id: "F013", name: "灯笼果", rarity: "普通", type: "水果", edibility: EDIBLE, eat_points: 1, discard_points: -1, role: SACRIFICE, synergy_tags: ["水果", "删牌", "摧毁"], effect: { kind: "gain_delete_token_destroy", description: "吃后摧毁自身，获得 1 枚删牌标记", trigger_action: "eat", tokens: 1 } }),
  ...
  card({ id: "K005", name: "发馊外卖", rarity: "罕见", type: "快餐", edibility: EDIBLE, eat_points: 3, discard_points: -2, role: ENGINE, shop_price_adjustment: -1, synergy_tags: ["快餐", "厌食", "生成"], effect: { kind: "sour_takeout", description: "吃后自身吃分永久 -1、弃分永久 +1；弃时若弃分小于 0，生成 1 张发馊外卖", eat_loss: 1, discard_gain: 1, generate_if_discard_below: 0 } }),
  card({ id: "K006", name: "变味炸鸡桶", art_file: "cards/k006-v2.png", rarity: "罕见", type: "快餐", edibility: EDIBLE, eat_points: 2, discard_points: -2, role: ENGINE, shop_price_adjustment: -1, synergy_tags: ["快餐", "厌食", "选牌"], effect: { kind: "spoiled_chicken_bucket", description: "吃：自身吃分永久 -1、弃分永久 +1；弃时若弃分小于 0，下次选牌必有 1 张快餐", eat_loss: 1, discard_gain: 1, force_type_if_discard_below: 0, forced_type: "快餐" } }),
  card({ id: "K007", name: "辣鸡翅", rarity: "罕见", type: "快餐", edibility: EDIBLE, eat_points: 3, discard_points: -1, role: ENGINE, synergy_tags: ["快餐", "厌食", "后置", "成长"], effect: { kind: "anorexia_postpone_drain", description: "吃后自身吃分永久 -1、弃分永久 +1；若本轮后置：牌堆下一张牌吃分永久 -1，自身吃分永久 +2", trigger_action: "eat", eat_loss: 1, discard_gain: 1 } }),
  card({ id: "K008", name: "三明治", art_file: "cards/k008-v2.png", rarity: "普通", type: "快餐", edibility: EDIBLE, eat_points: 2, discard_points: -2, role: ENGINE, shop_price_adjustment: -1, synergy_tags: ["快餐", "厌食", "机制"], effect: { kind: "sandwich_anorexia", description: "吃后自身吃分永久 -2、弃分永久 +2；吃或弃后，本轮剩余快餐的点数变动值翻倍", eat_loss: 2, discard_gain: 2 } }),
  ...
  card({ id: "K011", name: "隔夜餐盒", art_file: "cards/k010.webp", rarity: "稀有", type: "快餐", edibility: EDIBLE, eat_points: 1, discard_points: -1, role: ENGINE, synergy_tags: ["快餐", "后置", "成长"], effect: { kind: "postpone_mark_all_trade", description: "若本轮后置：将牌堆剩余牌全部标记为已后置；自身吃分永久降低剩余牌数量，弃分永久提高相同数量" } }),
  ...
  card({ id: "D007", name: "夹心饼干", rarity: "稀有", type: "甜点", edibility: EDIBLE, eat_points: 2, discard_points: -1, role: SACRIFICE, synergy_tags: ["甜点", "留存", "删牌"], effect: { kind: "retention", description: "弃：吃分永久 +2；10+ 吃下时点数翻倍，获得 1 枚删牌标记并摧毁自身", retain: 2, burst_threshold: 10, burst_multiplier: 2, burst_delete_tokens: 1, destroy_after_burst: true } }),
  ...
  card({ id: "B011", name: "浓缩咖啡", art_file: "cards/b010.webp", rarity: "普通", type: "饮料", edibility: EDIBLE, eat_points: 1, discard_points: -1, role: SACRIFICE, synergy_tags: ["饮料", "删牌", "摧毁"], effect: { kind: "gain_delete_token_destroy", description: "吃后摧毁自身，获得 1 枚删牌标记", trigger_action: "eat", tokens: 1 } }),
  ...
  card({ id: "A009", name: "理毛猫", art_file: "cards/a009-v2.png", rarity: "普通", type: "动物", edibility: INEDIBLE, eat_points: -1, discard_points: 2, role: SACRIFICE, synergy_tags: ["动物", "删牌", "摧毁"], effect: { kind: "gain_delete_token_destroy", description: "弃后摧毁自身，获得 1 枚删牌标记", trigger_action: "discard", tokens: 1 } }),
  ...
  card({ id: "C007", name: "黑洞胃", art_file: "cards/c007-v2.png", rarity: "稀有", type: "星体", edibility: INEDIBLE, eat_points: -3, discard_points: 2, role: PAYOFF, synergy_tags: ["星体", "硬吃", "爆发"], effect: { kind: "wrong_history_scale", description: "错误食性吃：本轮此前每次错误食性处理使本牌额外 +2 分", trigger_action: "eat", multiplier: 2 } }),
  card({ id: "C008", name: "引力井", rarity: "罕见", type: "星体", edibility: INEDIBLE, eat_points: -2, discard_points: -10, role: SACRIFICE, synergy_tags: ["星体", "摧毁", "延后"], effect: { kind: "delay_milestone_destroy", description: "弃后摧毁自身；将下一次目标结算延后 1 轮", trigger_action: "discard", delay: 1 } }),
  ...
  card({ id: "P002", name: "风险经纪人", art_file: "cards/p002-v2.png", rarity: "罕见", type: "人物", edibility: INEDIBLE, eat_points: -2, discard_points: -3, role: SACRIFICE, shop_price_adjustment: -2, synergy_tags: ["人物", "牺牲", "爆发", "位置"], effect: { kind: "first_discard_bonus", description: "弃：若该牌是你本轮第一张弃牌，额外 +7 分", trigger_action: "discard", bonus: 7 } }),
  ...
  card({ id: "P010", name: "美食评论家", rarity: "罕见", type: "人物", edibility: INEDIBLE, eat_points: -2, discard_points: 2, role: SETUP, synergy_tags: ["人物", "预判", "成长"], effect: { kind: "review_next_edibility", description: "弃：若下一张牌可食用，其结算时额外 +3；若不可食用，其弃点永久 -1", trigger_action: "discard", edible_bonus: 3, inedible_discard_loss: 1 } }),
  ...
  card({ id: "U007", name: "裁切券", rarity: "罕见", type: "通用", edibility: INEDIBLE, eat_points: -1, discard_points: -1, role: SACRIFICE, synergy_tags: ["通用", "删牌", "摧毁"], effect: { kind: "choice_score_or_delete_token", description: "吃：本次额外 +4 分；弃：摧毁自身并获得 1 枚删牌标记", eat_bonus: 4, tokens: 1 } }),
...
const ECONOMY_OVERRIDES = Object.freeze({
  F009: { synergy_tags: ["水果", "连击", "商店", "刷新"], effect: { kind: "fruit_combo", description: "吃：水果连击 +1；连击达到 3 或以上时，随后商店额外获得 1 次免费刷新", trigger_action: "eat", combo_gain: 1, bonus_per_combo: 1, grant_reroll_at: 3, shop_free_rerolls: 1 } },
