...
const CARD_DEFS = [
  ...
  card({ id: "F001", name: "苹果", flavor: "一颗普通的苹果。", rarity: "普通", type: "水果", edibility: EDIBLE, eat_points: 1, discard_points: -1, role: BASELINE, shop_price_adjustment: -2, synergy_tags: ["水果", "连击", "基础"], effect: { kind: "fruit_combo", description: "吃：水果连击 +1", trigger_action: "eat", combo_gain: 1, bonus_per_combo: 1, max_bonus: 6 } }),
...
const ECONOMY_OVERRIDES = Object.freeze({
  F009: { synergy_tags: ["水果", "连击", "商店", "刷新"], effect: { kind: "fruit_combo", description: "吃：水果连击 +1；连击达到 3 或以上时，随后商店额外获得 1 次免费刷新", trigger_action: "eat", combo_gain: 1, bonus_per_combo: 1, max_bonus: 6, grant_reroll_at: 3, shop_free_rerolls: 1 } },
